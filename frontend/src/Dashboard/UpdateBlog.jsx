 ...
 useEffect(() => {
  const fetchBlog = async () => {
    try {
      ...
      const blog = data.blog || data; // adapt based on your actual response

      setTitle(blog?.title || ""); // ✅ fallback to empty string
      setCategory(blog?.category || "");
      setAbout(blog?.about || "");
      setBlogImage(blog?.blogImage?.url || ""); // ✅ fallback to empty string
    } catch (error) {
